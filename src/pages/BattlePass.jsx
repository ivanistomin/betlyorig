...
function RewardRow({ reward, userLevel, isLast }) {
  ...
  const lang = 'ru'; // will use useLang below in parent
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: unlocked
              ...
              : 'none',
            color: unlocked || isCurrent ? '#fff' : 'rgba(255,255,255,0.3)',
          }}
        >
          {unlocked ? <CheckCircle className="w-4 h-4" /> : reward.level}
        </motion.div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p
              ...
              style={{
                color: unlocked ? cfg.color : isCurrent ? '#fff' : 'rgba(255,255,255,0.4)',
              }}
            >
              {reward.titleRu}
            </p>
      ...
      <div className="px-4 pt-5">
        ...
        >
          ...
          <p className="text-xs leading-relaxed" style={{ color: 'rgba(255,255,255,0.45)' }}>
            {lang === 'ru'
              ? 'Призы выдаются вручную. Достигнув нужного уровня, напиши в поддержку. TG-подарки приходят прямо в Telegram.'
              : 'Prizes are distributed manually. Contact support upon reaching the required level.'}
          </p>
        </div>
      </div>
    </div>
